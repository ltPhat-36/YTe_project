        ...
        <div class="w-full lg:w-[45%] bg-white flex flex-col px-6 sm:px-12 md:px-20 relative z-10 justify-center">
            ...
            <div class="w-full max-w-md mx-auto text-center">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    @error('email') <span class="text-red-500 text-sm text-left block pl-1 mt-1">{{ $message }}</span> @enderror
                    ...
                    @error('password') <span class="text-red-500 text-sm text-left block pl-1 mt-1">{{ $message }}</span> @enderror
