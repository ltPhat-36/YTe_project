...
<body class="h-screen w-full bg-white overflow-hidden">
    ...
    <div class="flex h-full w-full">
        ...
        <div class="w-full lg:w-[45%] bg-white flex flex-col px-6 sm:px-12 md:px-20 relative z-10 justify-center">
            ...
            <a href="/" class="absolute top-8 left-8 text-gray-400 hover:text-medpro transition">
            ...
            <div class="w-full max-w-md mx-auto text-center">
                ...
                <!-- FORM LOGIN (ĐÃ SỬA LẠI ĐÚNG CẤU TRÚC) -->
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="email" required autofocus value="<?php echo e(old('email')); ?>"
                            class="w-full pl-[88px] pr-4 py-3.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00b5f1] transition placeholder-gray-400 font-bold text-gray-700 shadow-sm" 
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm text-left block pl-1 mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" required 
                            class="w-full pl-10 pr-4 py-3.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00b5f1] transition placeholder-gray-400 font-medium shadow-sm" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center text-sm mt-6 pt-4 border-t border-gray-100">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-medpro font-extrabold hover:underline ml-1 text-base">
        ...
        <div class="hidden lg:block w-[55%] bg-image-wrapper relative">
            ...
            <div class="absolute top-1/3 right-[10%] text-right w-[400px]">
                <p class="text-[42px] font-quote text-gray-600 leading-tight mb-2">“Không còn:</p>
                <div class="relative inline-block mb-1"><p class="text-[32px] font-quote text-gray-600 pl-12 italic">xếp hàng</p><div class="absolute top-1/2 left-10 right-0 h-[2px] bg-gray-500 opacity-70 rotate-[-5deg]"></div></div><br>
                <div class="relative inline-block mb-4"><p class="text-[32px] font-quote text-gray-600 pl-12 italic">chờ đợi</p><div class="absolute top-1/2 left-10 right-0 h-[2px] bg-gray-500 opacity-70 rotate-[-5deg]"></div></div>
...
</html><?php /**PATH C:\xampp\htdocs\Project_Yte\resources\views/auth/login.blade.php ENDPATH**/ ?>