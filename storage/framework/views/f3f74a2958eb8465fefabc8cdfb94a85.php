...
<body class="bg-gray-50 font-sans antialiased text-gray-700">
    ...
    <div class="bg-white border-b hidden md:block">
        <div class="container mx-auto px-4 py-2 flex justify-between items-center text-xs text-gray-500">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="border border-cyan-500 text-cyan-500 px-3 py-1 rounded-md font-bold hover:bg-cyan-50 transition">
    Tài khoản
</a>
            </div>
        </div>
    ...
    <div class="relative group h-full flex items-center">
        ...
        <div class="py-2 flex flex-col gap-1 p-2">
            <a href="<?php echo e(route('search', ['type' => 'Bệnh viện công'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Bệnh viện công</a>
            <a href="<?php echo e(route('search', ['type' => 'Bệnh viện tư'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Bệnh viện tư</a>
            <a href="<?php echo e(route('search', ['type' => 'Phòng khám'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Phòng khám</a>
            <a href="<?php echo e(route('search', ['type' => 'Phòng mạch'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Phòng mạch</a>
            <a href="<?php echo e(route('search', ['type' => 'Xét nghiệm'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Xét nghiệm</a>
            <a href="<?php echo e(route('search', ['type' => 'Y tế tại nhà'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Y tế tại nhà</a>
            <a href="<?php echo e(route('search', ['type' => 'Tiêm chủng'])); ?>" class="block px-4 py-2 hover:text-cyan-600 hover:font-bold rounded-lg transition">Tiêm chủng</a>
        </div>
    </div>
    </div>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="relative group">
                            <button class="flex items-center gap-2 font-bold text-cyan-600">
                                <img src="<?php echo e(Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name)); ?>" class="w-8 h-8 rounded-full">
                                <span><?php echo e(Auth::user()->name); ?></span>
                            </button>
                            </div>
                    <?php else: ?>
                        <div class="lg:hidden">
                            <a href="<?php echo e(route('login')); ?>" class="text-cyan-600 font-bold">Đăng nhập</a>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="flex justify-between items-end">
                ...
                <div class="flex-1 text-center max-w-3xl mx-auto pb-10">
                    ...
                    <form action="<?php echo e(route('search')); ?>" method="GET" class="relative max-w-2xl mx-auto mb-8">
                        <div class="relative">
    ...
    <section class="container mx-auto px-4 py-10 bg-white">
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden border hover:border-cyan-500 transition group flex flex-col h-full">
                <div class="p-4">
                    <h3 class="font-bold text-lg text-gray-800"><?php echo e($hospital->name); ?></h3>
                 </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\Project_Yte\resources\views/welcome.blade.php ENDPATH**/ ?>