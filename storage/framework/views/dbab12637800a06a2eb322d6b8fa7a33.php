...
<body class="bg-gray-100 text-gray-800">
    ...
    <header class="bg-admin shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-white font-bold text-xl tracking-wider flex items-center gap-2 transition hover:text-blue-400">
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <form action="<?php echo e(route('admin.hospitals.store')); ?>" method="POST" enctype="multipart/form-data" class="p-8" onsubmit="compileSchedule()">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center gap-4 border-t pt-6">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-3 px-6 rounded-lg transition">
                        Hủy bỏ
                    </a>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\Project_Yte\resources\views/admin/hospitals/create.blade.php ENDPATH**/ ?>